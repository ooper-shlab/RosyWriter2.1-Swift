...
class PreviewMetalView: MTKView {
    ...
    private let syncQueue: DispatchQueue = {
        if #available(iOS 10.0, *) {
            return DispatchQueue(label: "Preview View Sync Queue", qos: .userInitiated, attributes: [], autoreleaseFrequency: .workItem)
        } else {
            return DispatchQueue(label: "Preview View Sync Queue", qos: .userInitiated, attributes: [], autoreleaseFrequency: .inherit)
        }
    }()
